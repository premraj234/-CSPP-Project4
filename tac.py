...
"""... from the lib.helper module we are importing the built in functions tac and readfile of the lib-helper module into our source"""
...
"""the print() function is used to print the output to the terminal .in the below print () it first executes the tac() function which takes one argument is used to print the output of given function"""
print(tac(TEXT))
