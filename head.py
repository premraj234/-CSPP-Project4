...
"""the print() function is used to print the output to the terminal.In the below print () function it first executes the head() function which takes one argument is used to print the output of given function"""
print(head(TEXT))
